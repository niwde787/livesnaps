...
export const UserManagementIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64.1 53.96" className={className} fill="currentColor">
        <g>
...
export const GlobalLeaderboardIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className} fill="currentColor">
        <path d="M50,1.4C23.2,1.4,1.4,23.2,1.4,50s21.7,48.6,48.6,48.6,48.6-21.7,48.6-48.6S76.8,1.4,50,1.4ZM62.9,33l4.8-.8c.3-.2,1.7-3.6,2.1-4.2.1-.2.2-.4.4-.4.4-.1.6,0,.8.3l2.2,4.4,4.8.7c1.3.7.2,1.3-.4,1.9-.9.9-1.8,1.8-2.6,2.7-.1,1,1,4.4.7,5.2,0,.1-.4.4-.5.4-.5.2-3.9-2.1-4.7-2.3-1.6.6-3.1,1.8-4.7,2.3-.6,0-.6-.5-.6-1.1,0-1.4.7-3,.7-4.5-1.1-1.4-2.6-2.3-3.6-3.7,0-.4.2-.7.5-.8ZM42.4,20.3l4.8-.8,2.1-4.2c.2-.4.6-.5,1-.3.5.2,2,4,2.5,4.6l4.8.7c.6.2.8.8.3,1.3l-3.4,3.3c0,1.5.7,3.2.7,4.6,0,.2,0,.6-.1.8,0,0-.4.2-.5.2-.7,0-3.7-2.1-4.7-2.3l-4.2,2.2c-.8.2-1-.1-1-.9,0-1.5.7-3.1.7-4.6l-3.4-3.4c-.4-.5-.2-1,.4-1.2ZM21.5,43.8c.6-.5,4.1-.5,5.1-.8l2.3-4.6c.3-.2.8-.2,1,0l2.3,4.5,4.9.7c.3.1.6.6.4.9-1.1,1.3-2.4,2.4-3.6,3.7,0,1.5.6,3,.7,4.4,0,.8,0,1.3-1,1.1l-4.2-2.2-4.3,2.2c-.3.1-.9,0-1-.3-.3-.8.8-4.1.7-5.2-1.1-1.3-2.6-2.4-3.6-3.8,0-.2.1-.5.3-.6ZM38.5,74c-.1,1.4-.9,2.6-2.4,2.8-4.3-.3-9,.4-13.3,0-1.6-.1-2.3-1.4-2.4-2.9-.3-4.5.3-9.5,0-14.1.1-1.4.9-2.4,2.2-2.7h13.5c1.5.2,2.3,1.3,2.4,2.7.4,4.6-.3,9.6,0,14.2ZM59.1,73.9c0,1.3-.7,2.4-2,2.8h-13.9c-1.5-.3-2.1-1.4-2.2-2.9v-37.2c0-1.5.9-2.7,2.3-2.9h13.3c1.5.2,2.4,1.5,2.4,2.9v37.3ZM79.7,73.9c0,1.4-.9,2.7-2.4,2.9-4.2.4-9.1-.3-13.4,0-1.4-.2-2.3-1.5-2.3-2.8v-24.9c.1-1.3,1-2.4,2.4-2.6,4.2.3,9.1-.5,13.2,0,1.5.2,2.5,1.4,2.5,2.9v24.7Z"/>
    </svg>
);
